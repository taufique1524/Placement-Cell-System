...
const { 
    ...
    updateResumeProfile} = require('../controllers/user.controller.js');
const { getAllSelections, deleteSelection, addSelections, checkStudentStatus, getAppliedAndShortlisted } = require('../controllers/selections.controller.js');
...
// Add this route
router.get('/check-student-status', checkStudentStatus);
router.get('/applied-and-shortlisted', getAppliedAndShortlisted);
...
.put('/profile/resume', authMiddleware, updateResumeProfile);
